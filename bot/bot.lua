...
if not tostring(SUDO):match('%d+') then
  ...
  config = {
   ...
   "plugins",
    ...
    sudo_users = {429112361, SUDO},--Sudo users
    master_id = SUDO, 
    token_bot = token, 
    disabled_channels = {},
...
⇣ An advanced administration bot based on *KASPER10K*

⇣ [KASPER10K](https://github.com/KASPER1984)
...
⇣ [KASPER10K](Telegram.Me/KASPER10K)

*⇣ Our Group Manger :*

[Group Manger](Telegram.Me/KASPER10K)
]],
  }
...
function bot_run()
	...
	bot = bot.result
	local runlog = "⇣  معرف بوتك : @"..bot.username.."\n⇣ يعمل على سورس كاسبر  توكن 👮‍♀️\n⇣ حساب مطورالسورس@KASPER10K"	print(runlog)
