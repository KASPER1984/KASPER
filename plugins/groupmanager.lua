...
return "⇣ ┇ مرحبا عزيزي\n⇣ ┇ تم ايقاف التحذير ☑️┇🔓"
	...
	if matches[1] == "ضع الترحيب" and matches[2] and is_mod(msg) then
	    ...
	    save_data(_config.moderation.data, data)
		return "⇣ ┇ تم وضع الترحيب بنجاح كلاتي 👋🏻\n*"..matches[2].."*\n\n⇣ ┇ ملاحظه\n⇣ ┇ تستطيع اضهار القوانين بواسطه  ➣ *{rules}*  \n⇣ ┇ تستطيع اضهار الاسم بواسطه ➣ *{name}*\n⇣ ┇ تستطيع اضهار المعرف بواسطه ➣ *{username}*"
	end
if matches[1] == "الترحيب"  and is_mod(msg) then
		...
		return "⇣ ┇ مرحباً عزيزي\n⇣ ┇ نورت المجموعه \n⇣ ┇ تابع : [KASPER10K](https://telegram.me/KASPER10K)"	end
end
if matches[1]== 'رسائلي' or matches[1]=='رسايلي' then
local msgs = tonumber(redis:get('msgs:'..msg.from.id..':'..msg.to.id) or 0)
return '⇣ ┇ عدد رسائلك : `'..msgs..'` رساله 👮‍♀️ \n\n'
end
...
setChatPhoto(msg.to.id, gpPhotoFile)
 ...
 if msg.newuser then
	...
	welcome = "⇣ ┇ مرحباً عزيزي\n⇣ ┇ نورت المجموعه \n⇣ ┇ تابع : [KASPER10K](https://telegram.me/KASPER10K)"
